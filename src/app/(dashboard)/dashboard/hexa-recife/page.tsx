...
import { COLUNAS_HEXA, GESTAO_HEXA, tabelaAusente, type HexaCliente } from '@/lib/hexa-recife'
...
export default async function HexaRecifePage() {
  ...
  /* Categoria de gestão: admin, dono e líder. Consultor fica de fora.
   *
   * Este redirect é conveniência — quem realmente fecha é a RLS
   * (2026-08-05_hexa_recife_inclui_lider.sql). Sem a policy, esconder a tela
