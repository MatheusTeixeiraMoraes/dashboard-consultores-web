    ...
    return (
      <div>
        ...
        <div className="bg-[#17171B] rounded-2xl border border-[#26262B] p-12 text-center">
          <div className="w-14 h-14 rounded-2xl bg-[#3A2E17] flex items-center justify-center mx-auto mb-4">
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#F5B04E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" />
              <line x1="12" y1="9" x2="12" y2="13" /><line x1="12" y1="17" x2="12.01" y2="17" />
            </svg>
          </div>
          <p className="font-semibold text-[#F4F4F5]">ID Carteira não configurado</p>
          <p className="text-sm text-[#8A8A93] mt-1">Solicite ao administrador que vincule seu ID de carteira ao perfil.</p>
        </div>
      </div>
    )
  }
  ...
  if (!latestDate) {
    return (
      <div>
        <div className="mb-6">
          <h1 className="text-xl font-bold text-[#F4F4F5]">Meu Desempenho</h1>
          <p className="text-sm text-[#8A8A93] mt-0.5">{profile.nome || profile.email} · Carteira {profile.id_carteira}</p>
        </div>
        <div className="bg-[#17171B] rounded-2xl border border-[#26262B] p-12 text-center">
          <p className="font-semibold text-[#F4F4F5]">Nenhum dado disponível ainda</p>
          <p className="text-sm text-[#8A8A93] mt-1">Aguarde o upload das planilhas pelo administrador.</p>
        </div>
      </div>
    )
  }
